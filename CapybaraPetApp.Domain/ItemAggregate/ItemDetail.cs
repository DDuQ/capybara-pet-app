...
public record ItemDetail
{
    ...
    {
        if (quantity > 100) return ItemErrors.QuantityCannotBeGreaterThan100;
        if (quantity * bonusEffect > 100) return ItemErrors.QuantityTimesBonusEffectCannotSurpass100;
